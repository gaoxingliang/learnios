//
//  AddAlarmOrEditViewController.swift
//  SwiftWeather
//
...
class AddAlarmOrEditViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    //
    ...
    //
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            if indexPath.section == 0 {
                ...
                if indexPath.row == 0 {
                    ...
                    sw.addTarget(self, action: #selector(AddAlarmOrEditViewController.snoozeSwitchTapped(_:)), for: UIControlEvents.touchUpInside)
        ...
        override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            ...
            if segue.identifier == Id.saveSegueIdentifier {
                let dist = segue.destination as! AlarmViewController
